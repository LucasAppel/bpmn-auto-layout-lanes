...
import { DEFAULT_CELL_HEIGHT, DEFAULT_CELL_WIDTH, LANE_EXTRA_HEIGHT } from './utils/layoutUtil.js';
...
export class Layouter {
  ...
  applyLaneLayout(process) {
    ...
    const result = remapGridRowsByLanes(process.grid, lanes, elementLaneMap);
...
function remapGridRowsByLanes(grid, lanes, elementLaneMap) {
  ...
  lanes.forEach(lane => {
    ...
    const rowCount = uniqueRows.length > 0 ? uniqueRows.length : 1;
